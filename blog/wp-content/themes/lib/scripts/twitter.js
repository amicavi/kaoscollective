function twigetGetTweet( tweets ){
    if ( ! ( window.twigetTweetsCount ) ){
        window.twigetTweetsCount = 0;
    }
    window.twigetTweetsCount++;
    window['twigetTweets-' + window.twigetTweetsCount] = tweets;
}

function twigetTwitter( target, options ) {
  
    var statusHTML = [];
    var twitters = window['twigetTweets-' + window.twigetTweetsCount];
