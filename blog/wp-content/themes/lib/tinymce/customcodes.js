    ...
    tinymce.create('tinymce.plugins.tabs', {  
        init : function(ed, url) {  
            ed.addButton('tabs', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[tabs]<br /><br />[tab title="tab 1"]Tab content 1[/tab]<br />[tab title="tab 2"]Tab content 2[/tab]<br />[tab title="tab 3"]Tab content 3[/tab]<br /><br />[/tabs]');  
    ...
    tinymce.create('tinymce.plugins.accordion', {  
        init : function(ed, url) {  
            ed.addButton('accordion', {  
                title : 'Add a accordion',  
                image : url+'/button-accordion.png',  
                onclick : function() {  
                     ed.selection.setContent('[accordions]<br /><br />[accordion title="Title 1"]content 1[/accordion]<br />[accordion title="Title 2"]content 2[/accordion]<br />[accordion title="Title 3"]content 3[/accordion]<br /><br />[/accordions]');  
    ...
    tinymce.create('tinymce.plugins.toggle', {  
        init : function(ed, url) {  
            ed.addButton('toggle', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[toggle title="Title here" ]Content Here[/toggle]');  
