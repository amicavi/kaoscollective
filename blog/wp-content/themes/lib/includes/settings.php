...
define('TPO_MESSAGE','<div class="trial-message" > <h1>Go PREMIUM!</h1><p>You are using the trial version of the musicnight theme. Upgrade to Premium version to enable the advance features of the theme like more than 50 shortcodes, more than 2 slider slides, blog options, fullwidth template, Unlimited Sidebar, Contact us template, etc. Also timely theme updates for lifetime and dedicated support will be provided.</p><a href="http://www.zebrathemes.com.com/buy/?wordpress-theme=musicnight" >http://www.zebrathemes.com.com/buy/?wordpress-theme=musicnight</a></div>');
...
define('TPO_BLOG_HIDE_THUMBNAIL', tpo_options($shortname . '_blog_cat_thumbnail'));
...
define('TPO_BLOG_HIDE_META', tpo_options($shortname . '_blog_cat_show_meta'));

define('TPO_BLOG_SHOW_METAPOSITION', tpo_options($shortname . '_blog_cat_meta_pos'));

define('TPO_BLOG_HIDE_AUTHOR', tpo_options($shortname . '_blog_cat_author'));

define('TPO_BLOG_HIDE_CATEGORIES', tpo_options($shortname . '_blog_cat_cat'));

define('TPO_BLOG_HIDE_DATE', tpo_options($shortname . '_blog_cat_date'));

define('TPO_BLOG_HIDE_COMMENTCOUNT', tpo_options($shortname . '_blog_cat_commentcount'));

define('TPO_BLOG_HIDE_TAGS', tpo_options($shortname . '_blog_cat_tags'));
...
define('TPO_PORTFOLIO_READMORE_TEXT', tpo_options($shortname . '_portfolio_readmore_text','Read More'));
...
define('TPO_PRIMARY_CUSTOM_NAV', tpo_options($shortname . '_primary_custom_nav'));
define('TPO_TOP_CUSTOM_NAV', tpo_options($shortname . '_top_custom_nav'));
define('TPO_DEFAULT_HOME_MENU', tpo_options($shortname . '_default_home_menu'));
