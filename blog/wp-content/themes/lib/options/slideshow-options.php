...
array( "name" => __("Generate slider from post.", THEME_SLUG ),
	"desc" => __("Check it, if you want to show WordPress posts in slider.", THEME_SLUG ),
	"id" => $shortname."_flex_from_post",
	"type" => "checkbox",
	"suffix" => "",
	"class" => "",
	"std" => ""),
...
array( "name" => __("Number of Slides", THEME_SLUG ),
	...
	"id" => $shortname."_flex_slide_count",
	"class" => "input_numeric",
	"maxlength" => "2",
	"type" => "textslider",
	"maximum" => "15",
...
array( "name" => __("Slider Speed", THEME_SLUG ),
	"desc" => __("Enter Length of time (in seconds) you want each image to be visible or stay there before moving to next. Default is 7 Second.", THEME_SLUG ),
	"id" => $shortname."_flex_sliderspeed",
	"class" => "input_numeric",
	"maxlength" => "2",
	"type" => "textslider",
	"maximum" => "20",
...
array( "name" => __("Slider Animation Speed", THEME_SLUG ),
	"desc" => __("Enter animation speed in seconds. Default is 1 Second.", THEME_SLUG ),
