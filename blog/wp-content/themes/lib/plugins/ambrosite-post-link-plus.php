 ...
 */
function previous_post_link_plus($args = '', $ext_text) {
	return adjacent_post_link_plus($args,  $ext_text . '%link', true);
}
 ...
 */
function next_post_link_plus($args = '', $ext_text) {
	return adjacent_post_link_plus($args, $ext_text . '%link', false);
}
