...
<div id="commentbox-left" >
	<label class="comment-label" for="author"><?php  _e('Name' , THEME_SLUG ); ?> <?php if ($req) echo "(required)"; ?></label>
    <input class="comment-text" type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
    
     <label class="comment-label" for="email"><?php  _e('Mail (will not be published)' , THEME_SLUG ); ?> <?php if ($req) echo "(required)"; ?></label>
    <input class="comment-text" type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />

    <label class="comment-label" for="url"><?php  _e('Website' , THEME_SLUG ); ?></label>  
    <input class="comment-text" type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
